    ...
    <div class="my-auto mx-auto w-full px-10">
      <div class="">
        ...
        <input-element 
          ...
          class="my-2"
        />
        <button type="button" class="bg-yellow-500 text-gray-500 py-2 px-4 hover:bg-yellow-400 hover:text-gray-600 transition-all ease-in-out duration-300" @click="createProduct">Create</button>
      </div>
    </div>
  </div>
</template>
